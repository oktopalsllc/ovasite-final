...
export default function Steps(){
  return (
    <div className="w-10/12 lg:w-9/12 mx-auto mt-30">
        <br/>
      <div id="features">
        <div>
      ...
      <div className="flex flex-col lg:flex-row my-12 md:my-20 justify-between items-start lg:gap-20">
        <div id="" className="w-full lg:w-1/2">
          ...
          <p className="text-base md:text-lg leading-9 font-normal text-start mt-4 md:mt-8">
      ...
      <div className="flex flex-col-reverse lg:flex-row my-12 md:mb-20 justify-between items-start lg:gap-20">
        ...
        <div id="" className="w-full lg:w-1/2">
          ...
          <p className="text-base md:text-lg leading-9 font-normal mt-4 md:mt-8">
      ...
      <div className="flex flex-col-reverse lg:flex-row my-12 md:my-20 justify-between items-start lg:gap-20">
        <div id="" className="w-full mb-8 lg:mt-0 lg:w-1/2">
          <Image
            className="w-full"
            alt="frame"
