  ...
  return (
    <div className='px-6 lg:px-20 min-h-[100vh]'>
      <div id='about'>
        <div className=''>
          <br />
          <div className='flex flex-col lg:flex-row justify-between lg:gap-10 gap-5 pt-20 px-10 lg:mb-10'>
    ...
    hover:bg-[#fe5000] rounded text-[#001233] font-bold text-white">
          ...
          <div id='second' className='pt-10 lg:mb-10 mx-10 flex flex-col lg:flex-row justify-between lg:gap-10 gap-5'>
            <div className='pt-10 lg:w-2/4 mb-10 text-center bg-white rounded-lg shadow-md shadow-slate-600 lg:p-10 p-4' >
            ...
            <div className='lg:w-2/4 mb-10 flex flex-col items-center justify-center' >
              <div className=''>
                <Image src='/MaskedGroup.png' width={400} height={500} alt='imagery' />
              </div>
              <p className='mb-5 lg:px-16 text-center text-gray-700 font-bold text-md lg:w-3/4 leading-loose'>Experience revolutionary features for gathering, analyzing, and utilizing data. From adaptable forms to real-time insights, Ovasite empowers you</p>
              <Link href="/signup" className="items-center bg-[#FF595A] border-0 py-4 px-6 focus:outline-none 
    hover:bg-[#fe5000] rounded text-[#001233] font-bold text-white">
                Get Started
              </Link>
      ...
      <div className='bg-[#0013330D] px-6 lg:px-20 py-10 mb-5 lg:mb-10'>
